...
class PlatformSetting(Base):
    ...
    resend_api_key: Mapped[str | None] = mapped_column(sa.String(255), nullable=True)
    from_email: Mapped[str | None] = mapped_column(sa.String(255), nullable=True)
    from_display_name: Mapped[str | None] = mapped_column(sa.String(120), nullable=True)
    reply_to: Mapped[str | None] = mapped_column(sa.String(255), nullable=True)
    ...
    assistant_requests_per_user_per_hour: Mapped[int | None] = mapped_column(Integer, nullable=True)
    assistant_requests_per_tenant_per_hour: Mapped[int | None] = mapped_column(Integer, nullable=True)
    dashboard_insights_min_refresh_seconds: Mapped[int | None] = mapped_column(Integer, nullable=True)
    dashboard_insights_max_per_tenant_per_hour: Mapped[int | None] = mapped_column(Integer, nullable=True)
