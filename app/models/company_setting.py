...
class CompanySetting(Base):
    ...
    invoice_email_subject_template: Mapped[str | None] = mapped_column(sa.Text, nullable=True)
    invoice_email_body_template: Mapped[str | None] = mapped_column(sa.Text, nullable=True)
    ticket_email_subject_template: Mapped[str | None] = mapped_column(sa.Text, nullable=True)
    ticket_email_body_template: Mapped[str | None] = mapped_column(sa.Text, nullable=True)
