...
HELP_TEXT.update(
    {
        ...
        "printing_qz_direct_print": "Turn this on when users should print directly to a printer attached to their workstation through the browser and QZ Tray. Platform admins manage the secure signing setup separately.",
        "printing_qz_printer_name": "Optional workstation printer name. Leave blank to let QZ Tray use the workstation default printer.",
