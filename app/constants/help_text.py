...
HELP_TEXT.update(
    {
        ...
        "platform_qz_management_boundary": "Platform admins manage signing readiness once. Tenant admins only choose printer behaviour on destinations and never see signing secrets.",
        ...
        "platform_qz_config_source": "Shows where the certificate and private key are being loaded from right now, plus whether each source validated successfully.",
