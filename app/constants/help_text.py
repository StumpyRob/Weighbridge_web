...
HELP_TEXT.update(
    {
        ...
        "printing_delivery_type": "Choose Browser Print for the workstation dialog, Site Agent for any local printer routing handled by the Windows agent, or Email PDF for invoice emails.",
        "printing_transport_config": "Delivery settings change with the selected method. Direct printer transports are legacy; use the Site Agent for operational printing.",
        "printing_agent_printer_role": "Optional routing key used by the site agent to map this destination to a local printer, for example ticket, invoice, or yard-main.",
        "printing_agent_printer_selection": "Select a printer synced from the assigned site agent. If none are available yet, use the manual printer field instead.",
