...
HELP_TEXT.update(
    {
        ...
        "platform_email_settings_scope": "Defines the platform SMTP connection and fallback sender identity used for outbound emails.",
        "platform_email_smtp_host": "The SMTP server hostname used to send outbound emails.",
        "platform_email_smtp_port": "The SMTP server port. Common values are 587 for STARTTLS and 465 for SSL/TLS.",
        "platform_email_smtp_username": "Optional username for SMTP authentication.",
        "platform_email_smtp_password": "Optional SMTP password. Leave blank to keep the saved password.",
        "platform_email_security": "STARTTLS upgrades a normal SMTP connection. SSL/TLS connects over an encrypted socket from the start.",
        ...
        "platform_email_test": "Sends a simple test email using the current SMTP settings so you can confirm delivery.",
