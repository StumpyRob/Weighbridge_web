...
HELP_TEXT.update(
    {
        ...
        "tenant_ai_overrides_scope": "This tenant page controls tenant-level AI overrides only. Leave override fields on platform default to fall back to the platform AI defaults.",
        "tenant_ai_assistant_enabled": "Controls whether the assistant drawer is available for this tenant. This does not change read-only safeguards or tenant isolation.",
        "tenant_ai_model_override": "Override the tenant model or leave it on platform default. gpt-5-mini is recommended for most tenants due to lower cost; gpt-5 is more expensive.",
        "tenant_ai_dashboard_override": "Override the tenant dashboard AI Insights state or leave it on platform default so it falls back to the platform setting.",
    }
)
