...
HELP_TEXT.update(
    {
        "printing_overview": "Printing uses templates (layout), printers (destination rules), and jobs (audit trail).",
        "printing_profile_concept": "A printer links a template, purpose, and destination settings for one print flow.",
        ...
        "printing_purpose": "Purpose tells the system what you are printing: Ticket Thermal, Ticket A4, Invoice (PDF), etc.",
        ...
        "printing_default_profile": "Default printers are used automatically when printing unless a different printer is selected.",
        "printing_active_profile": "Inactive printers do not appear for operators and are excluded from normal selection lists.",
        "printing_yard_scope": "Yard scope limits where a default printer applies. Global means available across all yards.",
        ...
        "printing_content_type": "TEXT is best for 80mm thermal receipts. HTML is best for A4 and styled layouts. Invoice PDF templates render as HTML and are converted to PDF.",
